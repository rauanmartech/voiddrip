  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black flex items-center justify-center overflow-hidden font-sans">
      <div className="relative w-full h-full">
        ...
        <div className="absolute inset-x-0 bottom-0 h-[50%] bg-gradient-to-t from-black via-black/90 to-transparent flex flex-col justify-end items-center pb-16 md:pb-24 px-8 text-center">
